...
\noindent
In this section, we performed a number of queries and analyses to demonstrate the We mainly used SQL queries and Python's data science toolset (Pandas\cite{citepandas}, NumPy\cite{citenumpy}, ScikitLearn\cite{cite_scikit-learn}) to retrieve, prepare,  and analyze the our data. The following sections provides details on our approach in preparing the data and performing the analysis.
